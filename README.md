...
## VAPT project directory structure

In this file you may find the whole VAPT directory structure which the relation of all screenshots, documentation, results and delivery documents that were used to do this project.
...
│   ├── metaspoloit-setting-attacker.png
│   ├── meterpreter-ps.png
...
│   ├── invalid-files.png
│   ├── md5-sum-verifation-integrity.png
│   ├── md5sum-8-jpg.png
